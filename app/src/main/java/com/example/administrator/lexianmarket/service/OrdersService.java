...
public class OrdersService {
    ...
    public static void getOrders(String pageNo, String state, String start,String end, final Handler handler){
        ...
        client.post(url,params,new HttpClientUtils.ServiceCallback() {
            ...
            public void onSuccess(String result) {
                Gson gson = new Gson();
                ResultHelper<Page<Order>> resultHelper=gson.fromJson(result,
                        new TypeToken<ResultHelper<Page<Order>>>() {}.getType());
