...
public class OrdersAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            vw.tvJiaqiAmount = (TextView) convertView.findViewById(R.id.tv_order_jiaqi_amount);
        ...
        vw.tvOrderState.setText(getPayWay(orders.getStates()));
        vw.tvStoreName.setText(orders.getStore().getStoreName());
        vw.tvJiaqiAmount.setText(orders.getJiaqiAmount());
    ...
    private String getPayWay(Integer payway){
    ...
    private static class OrdersViewHolder{
        ...
        private TextView tvJiaqiAmount;
    }
